(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,85544,e=>{"use strict";var a=e.i(43476),s=e.i(71645);e.i(47167);let t="u">typeof window,i={current:null},r={current:!1},n=[{key:"catalog",label:"קטלוג",href:"/catalog/",aria:"מעבר לקטלוג הבשמים"},{key:"about",label:"עלינו",href:"/about/",aria:"מעבר לעמוד עלינו"},{key:"contact",label:"צור קשר",href:"/contact/",aria:"מעבר לעמוד צור קשר"}],o=Array.from({length:34},(e,a)=>({left:(38*a+7)%100,top:(57*a+11)%100,size:1+a%3*.7,delay:337*a%9e3,dur:16e3+a%6*3400,sway:(a%2?1:-1)*(7+a%4*5)})),l=[{left:30,delay:0,dur:26e3,w:190},{left:55,delay:9e3,dur:32e3,w:150},{left:44,delay:17e3,dur:29e3,w:220}],c=`
.ess-land{
...
/* ===== מותג ===== */
.ess-brand{ position:absolute; z-index:3; top: clamp(1.6rem, 6vh, 4rem); left:0; right:0; text-align:center; }
.ess-name{
  margin:0; font-family: var(--font-display), Georgia, serif; font-weight:500;
  font-size: clamp(2.4rem, 7vw, 4.4rem); letter-spacing:.14em; line-height:1;
  color: var(--amber-gold);
  text-shadow: 0 0 30px rgba(200,149,43,.28);
}
.ess-latin{
  margin:.7rem 0 0; font-family: var(--font-bodoni), "Bodoni Moda", Didot, serif; font-weight:500;
  font-size: clamp(.58rem, 1.4vw, .74rem); letter-spacing:.42em; color: var(--muted-ivory); opacity:.72;
}
.ess-tagline{
  margin:.9rem 0 0; font-family: var(--font-display), serif; font-size: clamp(.86rem,1.7vw,1.02rem);
  letter-spacing:.16em; color: var(--muted-ivory); opacity:.62;
}
...
`;e.s(["default",0,function(){let e=function(){r.current||function(){if(r.current=!0,t)if(window.matchMedia){let e=window.matchMedia("(prefers-reduced-motion)"),a=()=>i.current=e.matches;e.addListener(a),a()}else i.current=!1}();let[e]=(0,s.useState)(i.current);return e}(),m=(0,s.useRef)(null),[d,p]=(0,s.useState)(null);return(0,s.useEffect)(()=>{let e=()=>p(null);return window.addEventListener("essence:spray-end",e),()=>window.removeEventListener("essence:spray-end",e)},[]),(0,a.jsxs)("section",{dir:"rtl","aria-label":"אסנס — מסך פתיחה",className:`ess-land${e?" ess-reduce":""}`,children:[(0,a.jsx)("style",{children:c}),(0,a.jsxs)("div",{"aria-hidden":!0,className:"ess-atmos",children:[(0,a.jsx)("div",{className:"ess-ember"}),(0,a.jsx)("div",{className:"ess-haze"}),!e&&(0,a.jsx)("div",{className:"ess-smoke",children:l.map((e,s)=>(0,a.jsx)("span",{style:{left:`${e.left}%`,width:`${e.w}px`,animationDelay:`${e.delay}ms`,animationDuration:`${e.dur}ms`}},s))}),!e&&(0,a.jsx)("div",{className:"ess-motes",children:o.map((e,s)=>(0,a.jsx)("span",{style:{left:`${e.left}%`,top:`${e.top}%`,width:`${e.size}px`,height:`${e.size}px`,"--sway":`${e.sway}px`,animationDelay:`${e.delay}ms`,animationDuration:`${e.dur}ms`}},s))}),(0,a.jsx)("div",{className:"ess-grain"}),(0,a.jsx)("div",{className:"ess-vignette"})]}),(0,a.jsxs)("header",{className:"ess-brand",children:[(0,a.jsx)("h1",{className:"ess-name",dir:"rtl",children:"אסנס"}),(0,a.jsx)("p",{className:"ess-latin",dir:"ltr",children:"MAISON DE PARFUM"}),(0,a.jsx)("p",{className:"ess-tagline",children:"בושם הוא זיכרון"})]}),(0,a.jsxs)("div",{className:"ess-flacon-wrap","aria-hidden":!0,children:[(0,a.jsxs)("div",{className:"ess-flacon",children:[(0,a.jsx)("img",{src:"/generated/hero-flacon-cut.png",alt:"",className:"ess-flacon-img",decoding:"async"}),(0,a.jsx)("span",{ref:m,className:"ess-nozzle"})]}),(0,a.jsx)("p",{className:"ess-notes","aria-hidden":!0,children:"וניל · עשן · אמבר"})]}),(0,a.jsx)("nav",{className:"ess-nav","aria-label":"ניווט ראשי",children:n.map(e=>(0,a.jsxs)("button",{type:"button","data-target":e.key,"aria-label":e.aria,"aria-disabled":!!d||void 0,className:`ess-opt${d===e.key?" is-chosen":""}${d&&d!==e.key?" is-dimmed":""}`,onClick:a=>(function(e,a){if(d)return;p(e.key);let s=m.current?.getBoundingClientRect(),t=a.getBoundingClientRect(),i=s?{x:s.left+s.width/2,y:s.top+s.height/2}:{x:window.innerWidth/2,y:.32*window.innerHeight},r={target:e.key,href:e.href,external:!!e.external,origin:i,rect:{x:t.left+t.width/2,y:t.top+t.height/2,w:t.width,h:t.height}};window.dispatchEvent(new CustomEvent("essence:spray",{detail:r}))})(e,a.currentTarget),children:[(0,a.jsx)("span",{className:"ess-opt-label",children:e.label}),(0,a.jsx)("span",{className:"ess-opt-underline","aria-hidden":!0})]},e.key))}),(0,a.jsx)("p",{className:"sr-only",role:"status","aria-live":"polite",children:d?`טוען ${n.find(e=>e.key===d)?.label}…`:""})]})}],85544)}]);